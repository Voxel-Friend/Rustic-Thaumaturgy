 ...
 *
 */
public class BrassCandleRecipe extends ShapedArcaneRecipe{

	public Aspect aspect = Aspect.AIR;
	
	public BrassCandleRecipe() 
	{
		super(new ResourceLocation(RusticThaumaturgy.MODID, "candle"), "RT_BRASS_CANDLES", 20, new AspectList().add(Aspect.FIRE,1).add(Aspect.AIR, 1), new ItemStack(ModBlocksRT.BRASS_CANDLES.get(Aspect.AIR)), "t", "i",
                //Recipe Ingredients
...
'i',new ItemStack(ItemsTC.ingots,1,2));
	...
	public ItemStack getCraftingResult(InventoryCrafting var1) {
		return new ItemStack(ModBlocksRT.BRASS_CANDLES.get(aspect), 3);
	}
