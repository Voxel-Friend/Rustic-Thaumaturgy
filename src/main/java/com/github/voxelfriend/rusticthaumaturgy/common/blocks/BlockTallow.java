...
public class BlockTallow extends BlockBase implements IInfusionStabiliser {
	...
	public BlockTallow(String name) {
		this(Material.CIRCUITS, name, true);
	}
	
	public BlockTallow(Material mat, String name, boolean register) {
